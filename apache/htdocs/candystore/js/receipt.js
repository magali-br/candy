...
function writeReceipt(first, last, num) {
	...
	top.wRef.document.writeln(
		...
		+'<center><font color=red><b><i>To print, <a href=# onclick="window.print();return false;">click here</a> or press Ctrl+P</i></b></font>'
...
function writeToWindow(aString) {
	print(aString);
	top.wRef=window.open('','myconsole',
		'width=500,height=450,left=10,top=10'
		+',menubar=1'
		...
		+',scrollbars=1'
		+',resizable=1');
	top.wRef.document.writeln(aString);
	top.wRef.document.close();
}
